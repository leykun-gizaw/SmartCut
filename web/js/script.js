...
tabulate.addEventListener('click', () => {
  ...
  reader.onload = (e) => {
    ...
    solve.addEventListener('click', () => {
      document.querySelector('#resultTab').click();
      eel.capture_data(parsedData)((optimized) => {
        let pages = 0;
...
function removeTable () {
  const prop = event.target.parentNode
